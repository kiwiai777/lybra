...
class LocalReadApiTests(unittest.TestCase):
    ...
    def test_static_markup_contains_records_and_agents_detail_markers(self) -> None:
        ...
        self.assertIn("workflow-inbox", html)
        self.assertIn("workflow-decision-desk", html)
        self.assertIn("workflow-publish-desk", html)
        self.assertIn("workflow-governance", html)
        self.assertIn("workflow-advanced-debug", html)
        self.assertIn("Today / Inbox", html)
        self.assertIn("Decision Desk", html)
        self.assertIn("Publish Desk", html)
        self.assertIn("Advanced / Debug", html)
        self.assertIn("<details id=\"workflow-advanced-debug\" class=\"workflow-group\">", html)
        ...
        self.assertIn("draft-publish-card", html)
        self.assertIn("draft-publish-raw-toggle", html)
        self.assertIn("<pre id=\"draft-publish-result\" hidden>", html)
        self.assertIn("renderDraftPublishCard", js)
        self.assertIn("toggleDraftPublishRaw", js)
        ...
        self.assertIn("owner-decision-record-prefill-resolution", html)
        ...
        self.assertIn("Owner Decision Record", html)
        self.assertIn("owner-record-decision-id", html)
        self.assertIn("owner-record-load-resolution", html)
        self.assertIn("owner-record-dry-run", html)
        self.assertIn("owner-record-confirm", html)
        self.assertIn("owner-record-result", html)
        ...
        self.assertIn("orchestration-summary-raw-toggle", html)
        self.assertIn("<pre id=\"orchestration-summary\" hidden>", html)
        self.assertIn("setOrchestrationSummaryRawVisible", js)
        self.assertIn("toggleOrchestrationSummaryRaw", js)
        ...
        self.assertIn("ownerDecisionRecordPayload", js)
        ...
        self.assertIn("loadOwnerRecordFromResolution", js)
        self.assertIn("runOwnerDecisionRecordDryRun", js)
        self.assertIn("confirmOwnerDecisionRecord", js)
        self.assertIn('operation: "owner_decision_record"', js)
