...
class ProjectEnforcementTests(unittest.TestCase):
    # --- R-α: 21 gated / 0 exempt (AIPOS-242: +lybra_project_status; AIPOS-249: +2 draft_submit) --
    def test_all_tool_handlers_are_project_gated_no_exemptions(self) -> None:
        self.assertEqual(len(TOOL_HANDLERS), 21)  # contract: a new tool must be counted + gated
